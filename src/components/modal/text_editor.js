...
export default function CKEditorComponent({set_editor}) {
    ...
    const create_editor = useCallback((orderDetails) => {
        ...
        let editor_html = document.getElementById("editor")
        let CKEDITOR = window.CKEDITOR
        CKEDITOR.ClassicEditor.create(editor_html, {
            toolbar: {
                items: [
    ...
    return (
        <div ref={CKEDITOR_ref} className="CKEditor dark:text-black dark:bg-white">
