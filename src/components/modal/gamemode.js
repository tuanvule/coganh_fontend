...
export default function Gamemode() {
    ...
    return (
        <div className="fixed w-full h-full flex flex-col">
            ...
            <div className="my-4 mx-auto h-[88%] overflow-y-scroll lg:w-[90%] w-[99%] dark:bg-[#0f2845] bg-[#a3dcff] rounded-lg flex flex-col py-4">
                <div className="mx-auto text-3xl font-semibold h-[10%]">CÁC CHẾ ĐỘ CHƠI</div>
                <div className="flex lg:flex-row flex-col h-[90%]">
                    <div className="lg:w-[49.95%] w-full h-full lg:mx-4 lg:px-4 grid place-content-center">
                        <div className="flex flex-col mx-auto justify-center items-center text-white">
                            {/* {mode === "human_bot" && */}
                                <div className="relative gamemode_item p-2 my-2 mx-1 rounded-sm select-none bg-slate-400 hover:brightness-90 cursor-pointer transition-all">
                                    <div className="w-48 h-48">
                                        <img src={chessboard} className=" object-cover" />
                                    </div>
                                    <p className="text-3xl w-full text-center pt-2">NORMAL</p>
                                    <div className="lg:hidden flex gamemode_item-nav absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                    ...
                    <hr className="w-[1px] h-full bg-[#007BFF] lg:block hidden" />
                    <div className="lg:w-[49.95%] w-full h-full lg:mx-4 lg:px-4 flex flex-col lg:mt-0 mt-4">
                        <ul className="p-0 m-0 overflow-y-scroll h-full lg:w-full w-[95%] mx-auto">
                            {user_gamemodes.sort((a,b) => (a.upvote.length - a.downvote.length - b.upvote.length - b.downvote.length)).reverse().map((item) => 
                                <li className="gamemode_item relative rounded flex hover:brightness-90 dark:bg-[#0e335b] bg-[#7ac8ff] p-4 mb-2 transition-all cursor-pointer">
                                    ...
                                    <div className="lg:hidden flex gamemode_item-nav absolute right-4 top-1/2 -translate-y-1/2">
